...
This module reads ``Output*`` tables from a selected SQLite model database and
...
2. Programmatic invocation from Geospatial-CANOE orchestration workflows after
   a successful model solve.
...
def export_output_tables(
    ...
    The function accepts an output directory and returns the generated workbook
    path in a list for compatibility with orchestration workflows. The returned list
