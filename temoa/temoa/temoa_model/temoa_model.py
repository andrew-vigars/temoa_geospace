...
class TemoaModel(AbstractModel):
    ...
    def __init__(M, *args, **kwargs):
        ...
        M.etlClusterProcess: dict[tuple, set[tuple]] = dict() # {(r_g, p, t_g): set((r, t))} valid processes built in p for an ETL cluster"""current available (within lifespan) vintages {(r, p, t) : set(v)}"""
